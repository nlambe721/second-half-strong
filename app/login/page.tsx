    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Men Over 40 AI Coaching Platform</p>
        </div>
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8">
          <h2 className="text-xl font-semibold text-white mb-6 text-center">Enter Your Access Code</h2>
          ...
          <p className="text-gray-600 text-xs text-center mt-6">
            Access codes are provided with your Men Over 40 Health Summit membership.
          </p>
        </div>
      </div>
    </div>
