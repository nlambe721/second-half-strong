...
- Dr. Elliot Justin (MyFirmTech / Sexspan Optimization) — sexual health IS cardiovascular health (not a separate category); the penis is the canary in the coal mine of cardiovascular and endocrine disease; the biggest myth in men's health: 85-87% of men labeled with ED get erections and LOSE them (blood retention problem) vs the 12-13% who cannot get erections (blood inflow/cardiovascular problem — these men need a cardiologist); nocturnal erections as leading cardiovascular indicator (50% drop in nocturnal erections = ~50% chance of cardiovascular event within 2-3 years); world's largest nocturnal erection database (250,000+ erections, 5,000 men); men in their late 60s maintain erection firmness comparable to men in their 30s; PDE5 medications (Viagra/Cialis) increase blood inflow but do NOT retain blood — rings address the real problem for 85-87% of men; MyFirmTech soft elastomer ring: safe (zero complications in 38,000+ rings), clinically effective (100% of EHS-3 men achieved satisfactory sex), extends ejaculatory phase by 50%; TRT effectiveness measured objectively through nocturnal erection data not subjective questions; Sexspan concept: optimize sexual healthspan not just treat dysfunction; Sexspan Optimization System (6-step: baseline assessment, sexual health audit, foundations, performance dashboard, 10% improvement, ongoing monitoring); work-life-sex balance
